...
let $calcularSalarioMensual = document.getElementById("salario-mensual");
$calcularSalarioMensual.onclick = function () {
  let mostrarSalarioMensual = document.getElementById("mostrar-salario-mensual");
  const salarioAnual = document.getElementById("salario-anual").value;
  const CANTIDAD_MESES_EN_UN_ANIO = 12;
  const salarioMensual = salarioAnual / CANTIDAD_MESES_EN_UN_ANIO;
